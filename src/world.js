...
export function createLevel(){
 ...
 enemies:[[850,760,1170],[1820,1600,1910],[2430,2330,2670],[3300,3060,3370],[3940,3860,4220],[4810,4560,4900],[5480,5420,5670],[6070,6000,6220]].map(([x,min,max],i)=>({x,y:408,w:34,h:32,min,max,vx:i%2?48:-48,hp:2,hit:0})),
 spikes:[{x:2070,y:424,w:50,h:16},{x:3780,y:424,w:55,h:16},{x:5360,y:424,w:55,h:16}],
 checkpoints:[{x:1630,active:false},{x:3060,active:false},{x:4580,active:false}],hearts:[{x:2350,y:333,taken:false},{x:4220,y:333,taken:false},{x:5750,y:336,taken:false}],goal:{x:6410,y:315,w:90,h:125}};
}
export function createPlayer(x=110,y=390){return {x,y,w:30,h:44,vx:0,vy:0,facing:1,grounded:false,coyote:0,buffer:0,jumpHeld:false,invulnerable:0,hp:5,shot:0};}
export function stepPlayer(p,input,solids,dt){
 ...
 p.vx=approach(p.vx,axis*TUNING.speed,(axis?(p.grounded?TUNING.groundAccel:TUNING.airAccel):(p.grounded?TUNING.groundBrake:TUNING.airBrake))*dt);
